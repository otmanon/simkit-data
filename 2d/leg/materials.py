...
winding_bot_bone = np.load(data_dir + "/2d/" + character_name + "/leg_w_bot_bone.npy").reshape(-1, 1)
winding_top_bone = np.load(data_dir + "/2d/" + character_name + "/leg_w_top_bone.npy").reshape(-1, 1)
