...
w_muscle_0 = winding_number(bc, V_list[1], E_list[1])
w_muscle_1 = winding_number(bc, V_list[2], E_list[2])
w_muscle_2 = winding_number(bc, V_list[3], E_list[3])
w_muscle_3 = winding_number(bc, V_list[4], E_list[4])
...
np.save(dir + "/" + name + "_w_muscle_0.npy", w_muscle_0 )
np.save(dir + "/" + name + "_w_muscle_1.npy", w_muscle_1 )
np.save(dir + "/" + name + "_w_muscle_2.npy", w_muscle_2 )
np.save(dir + "/" + name + "_w_muscle_3.npy", w_muscle_3 )

mesh = ps.register_surface_mesh("mesh", vertices, faces, edge_width=0)
mesh.add_scalar_quantity("w_muscle_0", w_muscle_0, defined_on='faces')
mesh.add_scalar_quantity("w_muscle_1", w_muscle_1, defined_on='faces')
mesh.add_scalar_quantity("w_muscle_2", w_muscle_2, defined_on='faces')
mesh.add_scalar_quantity("w_muscle_3", w_muscle_3, defined_on='faces')
